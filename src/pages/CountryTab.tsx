...
import { IonContent, IonHeader, IonPage, IonLoading, IonToolbar, IonRow, IonCol, IonCard, IonSlide, IonSlides, IonList, IonCardHeader, IonImg,  IonSelect, IonSelectOption   } from '@ionic/react';
